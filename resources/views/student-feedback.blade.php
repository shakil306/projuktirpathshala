                                    ...
                                    <div class="col-md-12">
                                        <div class="photo-grid">
                                            <div class="card card-wide">
                                                <img src="{{asset('uploads/student-feedback/feedback/image-1.png')}}" alt="student feedback">
                                            </div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-2.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-3.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-4.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-5.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-6.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-7.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-8.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-9.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-10.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-11.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-12.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-13.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-14.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-15.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/feedback/image-16.png')}});" alt="student feedback"></div>
                            ...
                            <div class="container student_feedback_tab_content">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="photo-grid">
                                            <div class="card card-wide">
                                                <img src="{{asset('uploads/student-feedback/image-2.png')}}" alt="student feedback">
                                            </div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-3.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-1.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-4.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-5.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-6.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-7.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-8.png')}});" alt="student feedback"></div>

                                            <div class="card" style="
                                        background-image: url({{asset('uploads/student-feedback/image-9.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-10.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-11.png')}});" alt="student feedback"></div>
                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-12.png')}}" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-13.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-14.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-15.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-16.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-17.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-18.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-19.png')}});" alt="student feedback"></div>

                                            <div class="card" style="
                                        background-image: url({{asset('uploads/student-feedback/image-20.png')}});" alt="student feedback"></div>

                                            <div class="card card-tall" style="
                                        background-image: url({{asset('uploads/student-feedback/image-21.png')}});" alt="student feedback"></div>

                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-22.png')}});" alt="student feedback"></div>
                                            <div class="card card-wide" style="
                                        background-image: url({{asset('uploads/student-feedback/image-23.png')}}" alt="student feedback"></div>
