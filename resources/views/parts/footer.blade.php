  ...
  <div class="container">
    ...
    <div class="row text-center justify-content-center pt-4">
      <div class="col">
        ...
        <img class="freelanceWebsiteLogo" src="{{asset('uploads/market_place/market-place-icons.png')}}" alt="marketplace">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row text-center justify-content-center pt-4">
      <div class="col paymentFooter">
        <img src="{{asset('uploads/market_place/Payment-icon.png')}}" alt="payment methods">
      </div>
    </div>
  </div>
</section>
...
<section class="footer-top" id="footer-top">
  <div class="container">
    ...
    <div class="row text-center">
      ...
      <div class="col">
        <div class="img">
          <a href="{{$sister->link}}" target="_blank"><img src="{{asset('uploads/sister/'.$sister->logo)}}" alt="{{$sister->alt}}"></a>
        </div>
      </div>
      @endforeach
    </div>
