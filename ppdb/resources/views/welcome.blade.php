...
@section('content')
                ...
                @foreach($welcome_slides as $welcome_slide)
                    @if($s_i==0)
                        <div class="carousel-item active">
                            <img style="width: 100%;height: 100%;" src="{{url('public/uploads/welcome/'.$welcome_slide->image)}}" class="d-block w-100 home-slider" alt="{{$welcome_slide->alt}}">
                        </div>
                    @else
        ...
        <div class="container">
            ...
            <div class="row wellcome-part">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    <img class="img-fluid" src="{{url('public/uploads/welcome/'.$welcome->image)}}" alt="{{$welcome->alt}}">
                </div>
                ...
                <div class="card-item text-center">
                    @foreach($courses as $course)
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 item">
                            <div class="card">
                                <img class="img-fluid" src="{{url('public/uploads/course/'.$course->image)}}" alt="{{$course->alt}}">
    ...
    <div class="container"><hr class="hr_welcome_area"></div>
    ...
    <div class="container"><hr class="hr_facility"></div>
                                    ...
                                    <div class="carousel-item active">
                                        <div class="card mb-3">
                                            <div class="row no-gutters">
                                                <div class="col-sm-4">
                                                    <img src="{{url('public/uploads/leader/'.$leader->image)}}" class="card-img"
                                                         alt="{{$leader->alt}}">
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="card-body">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 batch-item " id="batch-1">
                            <div class="row inside-item">
                                <div class="col-lg-5 col-md-5 col-sm-5 batch-image">
                                    <img src="{{url('public/uploads/batch/'.$batch->image)}}" alt="{{$batch->alt}}">
                                </div>
                                        ...
                                        @if($success_i==0)
                                            <div class="carousel-item active">
                                                <div class="card mb-3">
                                                    <div class="row no-gutters">
                                                        <div class="col-md-4">
                                                            <img src="{{url('public/uploads/success/'.$stud->image)}}" class="card-img"
                                                                 alt="{{$stud->alt}}">
                                                        </div>
                                                        <div class="col-md-8">
                                                            <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-12">
                    ...
                    <img class="career_counselling" src="{{url('public/uploads/welcome/'.$counselings->image)}}" alt="{{$counselings->alt}}">
